...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        var employee3 = new DegreeTeacher (new Person("Sara", "White"), "AB3333", new Course("Biology", "Pathology"),
                                                                                            "Magistr", "Rector");
        ...
        UniversityEmployee[] employees = { employee1, employee2, employee3, employee4, employee5, employee6 };
